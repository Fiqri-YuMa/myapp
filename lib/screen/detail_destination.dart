...
class DetailDestinasi3 extends StatefulWidget {
  final EventDestination destination;
  const DetailDestinasi3({super.key, required this.destination});

  @override
  State<DetailDestinasi3> createState() => _DetailDestinasi3State();
}

class _DetailDestinasi3State extends State<DetailDestinasi3> {
  PageController pageController = PageController();
  int pageView = 0;
  @override
  Widget build(BuildContext context) {
